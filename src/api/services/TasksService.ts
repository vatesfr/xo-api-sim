...
import type { Unbrand_XoTask_ } from '../models/Unbrand_XoTask_';
...
export class TasksService {
     ...
     * @throws ApiError
     */
    public static deleteTasks(): CancelablePromise<void> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/tasks',
            errors: {
    ...
    public static getTask({
        ...
        id: string,
        wait?: boolean,
    }): CancelablePromise<Unbrand_XoTask_> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/tasks/{id}',
            path: {
